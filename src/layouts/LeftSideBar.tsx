...
// images
import logoLight from "../assets/images/innovista-logo-white.png";
import logoDark from "../assets/images/innovista-logo-dark.png";
import logoSm from "../assets/images/innovista-logo-sm.png";
      ...
      <div className="app-menu">
        <Link to="/" className="logo-box">
          <div className="logo-light">
            <img src={logoLight} className="logo-lg-side h-6" alt="Light logo" />
            <img src={logoSm} className="logo-sm" alt="Small logo" />
          </div>
          <div className="logo-dark">
            <img src={logoDark} className="logo-lg-side h-6" alt="Dark logo" />
            <img src={logoSm} className="logo-sm" alt="Small logo" />
          </div>
        </Link>
