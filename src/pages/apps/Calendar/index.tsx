...
import { DateClickArg, Draggable } from "@fullcalendar/interaction/index.js";
...
const CalendarApp = () => {
  ...
  return (
    <>
      <PageBreadcrumb title='Calendar' name='Calendar' breadCrumbItems={["Innovista", "Apps", "Calendar"]} />
